<!-- Navigation Menu -->
<nav style="background-color: #f0f0f0; padding: 15px 0;">
  <ul style="list-style-type: none; margin: 0; padding: 0; text-align: center;">
    <li style="display: inline; margin: 0 30px;">
      <a href="#home" style="color: #333; text-decoration: none; font-size: 18px;">Home</a>
    </li>
    <li style="display: inline; margin: 0 30px;">
      <a href="#about" style="color: #333; text-decoration: none; font-size: 18px;">About</a>
    </li>
    <li style="display: inline; margin: 0 30px;">
      <a href="#contact" style="color: #333; text-decoration: none; font-size: 18px;">Contact</a>
    </li>
  </ul>
</nav>
